    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 image">
                <img src="1.jpg" alt=" " class="w-100 mb-5 mb-md-0" >
            </div>
...
<section class="services" id ="services">
  ...
  <div class="box-container container">
    <div class="box">
         <img src="logo2.svg" alt="" height="50px"width="50px">
        <h3>Alignment specialist</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo, fugit.</p>
    </div>
        <div class="box">
        <img src="logo4.svg" alt="" height="50px"width="50px">
        <h3>Cosmetic Dentistry</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo, fugit.</p>
    </div>
     <div class="box">
        <img src="logo3.svg" alt="" height="50px"width="50px">
        <h3>Oral hygiene Experts</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo, fugit.</p>
    </div>
     <div class="box">
        <img src="logo1.svg" alt="" height="50px"width="50px">
        <h3>root canal specialist</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo, fugit.</p>
    </div>
     <div class="box">
        <img src="logo2.jpg" alt="" height="50px"width="50px">
    ...
    <section class="process">
        ...
        <div class="box-container container">
            <div class="box">
                <img src="3-3.png" alt="" height="100px"width="100px">
                <h3>Cosmetic Dentistry</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, amet!</p>
            </div>
             <div class="box">
                <img src="1-1.png" alt=""height="100px" width="100px">
                <h3>Pediatric Dentistry</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, amet!</p>
            </div>
             <div class="box">
                <img src="2-2.jpg" alt=""height="100px" width="100px">
